...
export default function MapView() {
  ...
  useEffect(() => {
    ...
    // Step 1: Leaflet CSS load karo
    const link  = document.createElement("link");
    link.rel    = "stylesheet";
    link.href   = "https://unpkg.com/leaflet@1.9.4/dist/leaflet.css";
    document.head.appendChild(link);

    // Step 2: Leaflet JS load karo
    ...
    script.onload  = () => {
      ...
      // Har city ke liye marker + heatmap circle
      FLOOD_DATA.forEach((city) => {
        const color = RISK_COLORS[city.risk];

        // Heatmap circle — size = actual EMDAT event count
        ...
        // Click karne pe popup — real EMDAT data
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          🗺️ India Flood Risk — EM-DAT 1900–2021 · Markers click karo
        </div>
